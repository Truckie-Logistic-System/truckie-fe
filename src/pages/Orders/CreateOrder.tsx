...
import { Button, Form, Steps, Card, Typography, notification, Spin } from "antd";
...
const CreateOrder = () => {
    ...
    const handleSubmit = async (values: any) => {
        ...
        try {
            ...
            notification.error({
                ...
                description: err.message || "Có lỗi xảy ra khi tạo đơn hàng. Vui lòng thử lại sau.",
            });
        } finally {
    ...
    const validateForm = async () => {
        try {
            ...
            switch (currentStep) {
                case 0:
                    fieldsToValidate = ['receiverName', 'receiverPhone', 'categoryId', 'packageDescription'];
                    break;
                case 1:
    ...
    const renderForm = () => {
        ...
        if (error) {
            return (
                <div className="p-6 bg-red-50 rounded-md">
                    <Title level={4} className="text-red-500">Đã xảy ra lỗi</Title>
        ...
        switch (currentStep) {
            ...
            case 1:
                return <PackageInfoStep orderSizes={orderSizes} />;
            case 2:
        ...
        <div className="p-6">
            ...
            <Card className="mb-6">
                <Steps current={currentStep} className="mb-8">
                    <Step title="Thông tin người nhận" description="Nhập thông tin người nhận" />
                    <Step title="Kích thước & trọng lượng" description="Nhập thông tin gói hàng" />
