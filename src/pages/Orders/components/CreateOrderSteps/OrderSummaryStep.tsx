...
import { Typography, Divider, Card, Tag, Row, Col } from "antd";
import {
  IdcardOutlined,
  PhoneOutlined,
  ShopOutlined,
          ...
          formValues.orderDetailsList.length > 0 ? (
            <div>
              ...
              <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <Text className="block text-sm text-blue-600 mt-1">
              ...
              {formValues.orderDetailsList.map((detail: any, index: number) => (
                <div key={index} className="mb-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <Row gutter={12}>
                      ...
                      <Col span={10}>
                        <div>
                          <Text strong className="block">
                            Khoảng kích thước (Dài x Cao x Rộng)
                          </Text>
                          <Text>
                            {(() => {
                  ...
                  {index < formValues.orderDetailsList.length - 1 && (
