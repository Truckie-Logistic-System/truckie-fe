...
const VehicleAssignmentDetailPage: React.FC = () => {
    ...
    const updateMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            queryClient.invalidateQueries({ queryKey: ["vehicleAssignment", id] });
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            navigate("/admin/vehicle-assignments");
        },
        onError: (error) => {
            ...
            <div className="p-6">
                <div className="bg-red-50 border border-red-200 text-red-700 p-4 rounded-lg">
                    ...
                    <Button
                        ...
                        danger
                        className="mt-2"
                        onClick={() => navigate("/admin/vehicle-assignments")}
                    >
                        ...
                        <Col span={12}>
                            <Card
                                ...
                                extra={
                                    <Button
                                        type="link"
                                        onClick={() => navigate(`/admin/vehicles/${assignment.vehicleId}`)}
                                    >
                                        Xem chi tiết xe
                                    </Button>
                                }
                        ...
                        <Col span={12}>
                            <Card
                                ...
                                extra={
                                    <Button
                                        type="link"
                                        onClick={() => navigate(`/admin/drivers/${assignment.driver_id_1}`)}
                                    >
                                        Xem chi tiết tài xế
                                    </Button>
                                }
                            ...
                            <Col span={24}>
                                <Card
                                    ...
                                    extra={
                                        <Button
                                            type="link"
                                            onClick={() => navigate(`/admin/drivers/${assignment.driver_id_2}`)}
                                        >
                                            Xem chi tiết tài xế
                                        </Button>
                                    }
