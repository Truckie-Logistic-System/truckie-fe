    ...
    return (
        <Modal
            title={
                <div className="flex items-center">
                    <TeamOutlined className="text-blue-500 mr-2 text-xl" />
                    <span>Cập nhật trạng thái nhân viên</span>
                </div>
            }
            open={visible}
            onOk={onOk}
        ...
        >
            <div className="flex items-center mb-6">
                ...
                />
                <div>
                    <div className="text-lg font-medium">{staff?.fullName}</div>
                    <div className="text-gray-500">{staff?.email}</div>
                    <div className="mt-1">
                        <span
                            className={`px-2 py-1 text-xs rounded-full ${getStatusColor(staff?.status || '') === 'green'
                                    ? 'bg-green-100 text-green-700'
                                    : getStatusColor(staff?.status || '') === 'red'
                                ...
                                <div className="flex items-start gap-3 text-left">
                                    ...
                                    <div>
                                        ...
                                        <div style={{
                                            ...
                                            Nhân viên có thể đăng nhập và sử dụng hệ thống
                                        </div>
                                    </div>
                                </div>
                            </Radio.Button>
                                ...
                                <div className="flex items-start gap-3 text-left">
                                    ...
                                    <div>
                                        ...
                                        <div style={{
                                            ...
                                            Nhân viên không thể đăng nhập và sử dụng hệ thống
                                        </div>
                                    </div>
                                </div>
                            </Radio.Button>
