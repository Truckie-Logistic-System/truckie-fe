...
const CategoryManagement: React.FC = () => {
    ...
    const {
        ...
        queryFn: categoryService.getCategoryPricingDetails
    });
    ...
    const filteredCategoryPricing = categoryPricingData?.data?.filter(pricing => {
        if (!searchText) return true;
        const searchLower = searchText.toLowerCase();
        return (
            pricing.categoryResponse.categoryName.toLowerCase().includes(searchLower)
        );
    }) || [];
